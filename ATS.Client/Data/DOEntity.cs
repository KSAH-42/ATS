...
namespace ATS.Client.Data
{
	public abstract class DOEntity : DORoot
	{
		...
		public string Name
		{
			...
			set => SetField( ref _name , DataFilter.ReplaceNull( value ) );
		}

		public string Description
		{
			get => GetField( ref _description );
			set => SetField( ref _description , DataFilter.ReplaceNull( value ) );
		}

		public string Comments
		{
			get => GetField( ref _comments );
			set => SetField( ref _comments , DataFilter.ReplaceNull( value ) );
		}
